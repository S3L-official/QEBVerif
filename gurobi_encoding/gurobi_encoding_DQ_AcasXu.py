...
class QNNEncoding_gurobi:
    ...
    def sat(self, args, prediction):
        ...
        fo = open(path + "/Prop_" + str(property) + str("_Net_") + str(AcasNet) + "_qu_" + str(
            args.qu_bit) + "_err_" + errorString + "_mode_" + str(mode) + "_ifDiff_" + str(ifDiff) + "_gp.txt",
                  "w")
    ...
    if abs(target_diff_lb) <= args.error and abs(target_diff_ub) <= args.error:
        ...
        fo = open(
            path + "/Prop_" + str(args.property) + "_Net_" + str(args.AcasNet) + "_qu_" + str(
                args.qu_bit) + "_err_" + str(args.error) + "_mode_" + str(args.mode) + "_ifDiff_" + str(
